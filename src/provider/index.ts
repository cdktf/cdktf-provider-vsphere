// https://registry.terraform.io/providers/hashicorp/vsphere/2.8.0/docs
...
export class VsphereProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing VsphereProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.8.0/docs#import import section} in the documentation of this resource for the id to use
