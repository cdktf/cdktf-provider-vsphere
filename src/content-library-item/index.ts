...
// https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs/resources/content_library_item
...
export class ContentLibraryItem extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ContentLibraryItem that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs/resources/content_library_item#import import section} in the documentation of this resource for the id to use
