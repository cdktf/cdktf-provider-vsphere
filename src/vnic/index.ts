...
// https://registry.terraform.io/providers/hashicorp/vsphere/2.6.0/docs/resources/vnic
...
export class Vnic extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Vnic that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.6.0/docs/resources/vnic#import import section} in the documentation of this resource for the id to use
