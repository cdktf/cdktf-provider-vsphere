// https://registry.terraform.io/providers/hashicorp/vsphere/2.12.0/docs/data-sources/compute_cluster_host_group
...
export interface DataVsphereComputeClusterHostGroupConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class DataVsphereComputeClusterHostGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVsphereComputeClusterHostGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.12.0/docs/data-sources/compute_cluster_host_group#import import section} in the documentation of this resource for the id to use
  ...
  * @param options DataVsphereComputeClusterHostGroupConfig
  */
  public constructor(scope: Construct, id: string, config: DataVsphereComputeClusterHostGroupConfig) {
    super(scope, id, {
  ...
  // host_system_ids - computed: true, optional: false, required: false
