...
// https://registry.terraform.io/providers/hashicorp/vsphere/2.9.0/docs/data-sources/compute_cluster_host_group
...
export class DataVsphereComputeClusterHostGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVsphereComputeClusterHostGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.9.0/docs/data-sources/compute_cluster_host_group#import import section} in the documentation of this resource for the id to use
