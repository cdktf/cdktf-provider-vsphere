...
// https://registry.terraform.io/providers/vmware/vsphere/2.14.1/docs/data-sources/datacenter
...
export class DataVsphereDatacenter extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVsphereDatacenter that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.1/docs/data-sources/datacenter#import import section} in the documentation of this resource for the id to use
