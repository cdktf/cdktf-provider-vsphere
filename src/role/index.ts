...
// https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs/resources/role
...
export class Role extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Role that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs/resources/role#import import section} in the documentation of this resource for the id to use
