...
// https://registry.terraform.io/providers/hashicorp/vsphere/2.8.3/docs/resources/ha_vm_override
...
export class HaVmOverride extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HaVmOverride that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.8.3/docs/resources/ha_vm_override#import import section} in the documentation of this resource for the id to use
