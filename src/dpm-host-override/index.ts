...
// https://registry.terraform.io/providers/hashicorp/vsphere/2.8.0/docs/resources/dpm_host_override
...
export class DpmHostOverride extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DpmHostOverride that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.8.0/docs/resources/dpm_host_override#import import section} in the documentation of this resource for the id to use
