...
// https://registry.terraform.io/providers/vmware/vsphere/2.15.0/docs/data-sources/ovf_vm_template
...
export class DataVsphereOvfVmTemplate extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVsphereOvfVmTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vsphere/2.15.0/docs/data-sources/ovf_vm_template#import import section} in the documentation of this resource for the id to use
