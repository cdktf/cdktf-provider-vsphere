...
// https://registry.terraform.io/providers/vmware/vsphere/2.15.0/docs/resources/tag_category
...
export class TagCategory extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TagCategory that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vsphere/2.15.0/docs/resources/tag_category#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/vsphere/2.15.0/docs/resources/tag_category vsphere_tag_category} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      associable_types: {
        value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(this._associableTypes),
        isBlock: false,
        type: "set",
        storageClassType: "stringList",
      },
      cardinality: {
        value: cdktf.stringToHclTerraform(this._cardinality),
        isBlock: false,
        type: "simple",
