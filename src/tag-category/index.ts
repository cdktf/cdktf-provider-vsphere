...
// https://registry.terraform.io/providers/hashicorp/vsphere/2.6.1/docs/resources/tag_category
...
export class TagCategory extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TagCategory that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.6.1/docs/resources/tag_category#import import section} in the documentation of this resource for the id to use
