...
// https://registry.terraform.io/providers/vmware/vsphere/2.15.0/docs/resources/offline_software_depot
...
export class OfflineSoftwareDepot extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OfflineSoftwareDepot that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vsphere/2.15.0/docs/resources/offline_software_depot#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vmware/vsphere/2.15.0/docs/resources/offline_software_depot vsphere_offline_software_depot} Resource
  *
  * @param scope The scope in which to define this construct
