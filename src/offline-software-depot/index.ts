// https://registry.terraform.io/providers/hashicorp/vsphere/2.8.3/docs/resources/offline_software_depot
...
export class OfflineSoftwareDepot extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OfflineSoftwareDepot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.8.3/docs/resources/offline_software_depot#import import section} in the documentation of this resource for the id to use
