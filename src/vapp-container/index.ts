...
// https://registry.terraform.io/providers/hashicorp/vsphere/2.8.3/docs/resources/vapp_container
...
export class VappContainer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VappContainer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.8.3/docs/resources/vapp_container#import import section} in the documentation of this resource for the id to use
