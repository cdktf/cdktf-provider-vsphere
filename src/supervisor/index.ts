...
// https://registry.terraform.io/providers/hashicorp/vsphere/2.9.0/docs/resources/supervisor
...
export class Supervisor extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Supervisor that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.9.0/docs/resources/supervisor#import import section} in the documentation of this resource for the id to use
