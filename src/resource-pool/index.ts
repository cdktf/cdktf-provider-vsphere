...
// https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs/resources/resource_pool
...
export class ResourcePool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ResourcePool that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs/resources/resource_pool#import import section} in the documentation of this resource for the id to use
