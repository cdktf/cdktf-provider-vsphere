// https://registry.terraform.io/providers/hashicorp/vsphere/2.6.0/docs/resources/nas_datastore
...
export class NasDatastore extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NasDatastore that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.6.0/docs/resources/nas_datastore#import import section} in the documentation of this resource for the id to use
