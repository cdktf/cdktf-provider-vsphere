...
// https://registry.terraform.io/providers/hashicorp/vsphere/2.9.2/docs/resources/storage_drs_vm_override
...
export class StorageDrsVmOverride extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StorageDrsVmOverride that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.9.2/docs/resources/storage_drs_vm_override#import import section} in the documentation of this resource for the id to use
