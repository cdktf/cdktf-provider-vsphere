// https://registry.terraform.io/providers/hashicorp/vsphere/2.9.1/docs/resources/folder
...
export class Folder extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Folder that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.9.1/docs/resources/folder#import import section} in the documentation of this resource for the id to use
