...
// https://registry.terraform.io/providers/vmware/vsphere/2.14.0/docs/resources/datastore_cluster_vm_anti_affinity_rule
...
export class DatastoreClusterVmAntiAffinityRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatastoreClusterVmAntiAffinityRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.0/docs/resources/datastore_cluster_vm_anti_affinity_rule#import import section} in the documentation of this resource for the id to use
