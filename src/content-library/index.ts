...
// https://registry.terraform.io/providers/vmware/vsphere/2.13.0/docs/resources/content_library
...
export class ContentLibrary extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ContentLibrary that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vsphere/2.13.0/docs/resources/content_library#import import section} in the documentation of this resource for the id to use
