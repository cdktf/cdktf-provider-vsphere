...
// https://registry.terraform.io/providers/hashicorp/vsphere/2.12.0/docs/resources/custom_attribute
...
export class CustomAttribute extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CustomAttribute that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.12.0/docs/resources/custom_attribute#import import section} in the documentation of this resource for the id to use
