...
// https://registry.terraform.io/providers/hashicorp/vsphere/2.8.3/docs/data-sources/host_vgpu_profile
...
export class DataVsphereHostVgpuProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVsphereHostVgpuProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.8.3/docs/data-sources/host_vgpu_profile#import import section} in the documentation of this resource for the id to use
