...
// https://registry.terraform.io/providers/vmware/vsphere/2.15.0/docs/data-sources/host_vgpu_profile
...
export class DataVsphereHostVgpuProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVsphereHostVgpuProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vsphere/2.15.0/docs/data-sources/host_vgpu_profile#import import section} in the documentation of this resource for the id to use
