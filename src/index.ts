...
export * as offlineSoftwareDepot from './offline-software-depot';
...
export * as virtualMachineClass from './virtual-machine-class';
...
export * as dataVsphereHostBaseImages from './data-vsphere-host-base-images';
