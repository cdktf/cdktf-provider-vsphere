...
| <code><a href="#@cdktf/provider-vsphere.distributedVirtualSwitch.DistributedVirtualSwitchConfig.property.ignoreOtherPvlanMappings">IgnoreOtherPvlanMappings</a></code> | <code>interface{}</code> | Whether to ignore existing PVLAN mappings not managed by this resource. |
