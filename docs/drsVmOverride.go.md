...
```go
import "github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v11/drsvmoverride"
...
| <code><a href="#@cdktf/provider-vsphere.drsVmOverride.DrsVmOverrideConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.0/docs/resources/drs_vm_override#id DrsVmOverride#id}. |
