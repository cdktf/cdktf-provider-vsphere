...
```go
import "github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v10/offlinesoftwaredepot"
...
| <code><a href="#@cdktf/provider-vsphere.offlineSoftwareDepot.OfflineSoftwareDepotConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.12.0/docs/resources/offline_software_depot#id OfflineSoftwareDepot#id}. |
