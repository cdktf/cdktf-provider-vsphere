...
```go
import "github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v11/havmoverride"
...
| <code><a href="#@cdktf/provider-vsphere.haVmOverride.HaVmOverrideConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.13.0/docs/resources/ha_vm_override#id HaVmOverride#id}. |
