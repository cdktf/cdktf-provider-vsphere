...
```go
import "github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v6/havmoverride"
...
| <code><a href="#@cdktf/provider-vsphere.haVmOverride.HaVmOverrideConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.4.2/docs/resources/ha_vm_override#id HaVmOverride#id}. |
