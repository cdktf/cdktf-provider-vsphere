...
```go
import "github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v6/datavspherevappcontainer"
...
| <code><a href="#@cdktf/provider-vsphere.dataVsphereVappContainer.DataVsphereVappContainerConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.4.2/docs/data-sources/vapp_container#id DataVsphereVappContainer#id}. |
