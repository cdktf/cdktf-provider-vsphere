...
```go
import "github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v10/virtualmachineclass"
...
| <code><a href="#@cdktf/provider-vsphere.virtualMachineClass.VirtualMachineClassConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.12.0/docs/resources/virtual_machine_class#id VirtualMachineClass#id}. |
