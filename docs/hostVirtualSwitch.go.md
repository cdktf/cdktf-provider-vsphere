...
```go
import "github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v10/hostvirtualswitch"
...
| <code><a href="#@cdktf/provider-vsphere.hostVirtualSwitch.HostVirtualSwitchConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.12.0/docs/resources/host_virtual_switch#id HostVirtualSwitch#id}. |
