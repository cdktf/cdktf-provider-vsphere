...
```go
import "github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v8/datavspheretag"
...
| <code><a href="#@cdktf/provider-vsphere.dataVsphereTag.DataVsphereTagConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.5.1/docs/data-sources/tag#id DataVsphereTag#id}. |
