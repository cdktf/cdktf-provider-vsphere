...
```go
import "github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v8/computeclustervmgroup"
...
| <code><a href="#@cdktf/provider-vsphere.computeClusterVmGroup.ComputeClusterVmGroupConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.6.0/docs/resources/compute_cluster_vm_group#id ComputeClusterVmGroup#id}. |
