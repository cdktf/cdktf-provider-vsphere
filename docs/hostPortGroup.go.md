...
```go
import "github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v6/hostportgroup"
...
| <code><a href="#@cdktf/provider-vsphere.hostPortGroup.HostPortGroupConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.4.2/docs/resources/host_port_group#id HostPortGroup#id}. |
