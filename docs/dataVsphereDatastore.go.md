...
```go
import "github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v7/datavspheredatastore"
...
| <code><a href="#@cdktf/provider-vsphere.dataVsphereDatastore.DataVsphereDatastoreConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.4.2/docs/data-sources/datastore#id DataVsphereDatastore#id}. |
