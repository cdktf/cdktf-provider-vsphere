...
```go
import "github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v5/contentlibrary"
...
&contentlibrary.ContentLibraryConfig {
	...
	Description: *string,
	Id: *string,
	Publication: github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v5.contentLibrary.ContentLibraryPublication,
	Subscription: github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v5.contentLibrary.ContentLibrarySubscription,
}
```
