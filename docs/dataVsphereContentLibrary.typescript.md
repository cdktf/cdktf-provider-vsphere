...
```typescript
import { dataVsphereContentLibrary } from '@cdktf/provider-vsphere'

new dataVsphereContentLibrary.DataVsphereContentLibrary(scope: Construct, id: string, config: DataVsphereContentLibraryConfig)
```
...
dataVsphereContentLibrary.DataVsphereContentLibrary.isConstruct(x: any)
```
...
dataVsphereContentLibrary.DataVsphereContentLibrary.isTerraformElement(x: any)
```
...
dataVsphereContentLibrary.DataVsphereContentLibrary.isTerraformDataSource(x: any)
```
...
dataVsphereContentLibrary.DataVsphereContentLibrary.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktf/provider-vsphere.dataVsphereContentLibrary.DataVsphereContentLibrary.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
const dataVsphereContentLibraryConfig: dataVsphereContentLibrary.DataVsphereContentLibraryConfig = { ... }
```
