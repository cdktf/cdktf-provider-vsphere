...
```go
import "github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v8/datavspherefolder"
...
| <code><a href="#@cdktf/provider-vsphere.dataVsphereFolder.DataVsphereFolderConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.6.0/docs/data-sources/folder#id DataVsphereFolder#id}. |
