...
```go
import "github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v6/datavspherecomputecluster"
...
| <code><a href="#@cdktf/provider-vsphere.dataVsphereComputeCluster.DataVsphereComputeClusterConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.4.1/docs/data-sources/compute_cluster#id DataVsphereComputeCluster#id}. |
