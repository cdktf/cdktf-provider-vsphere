...
```go
import "github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v11/licenseresource"
...
| <code><a href="#@cdktf/provider-vsphere.licenseResource.LicenseResourceConfig.property.labels">Labels</a></code> | <code>*map[string]*string</code> | A map of labels to be applied to the license key. |
