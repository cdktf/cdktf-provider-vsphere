...
```go
import "github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v6/role"
...
| <code><a href="#@cdktf/provider-vsphere.role.RoleConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.4.1/docs/resources/role#id Role#id}. |
