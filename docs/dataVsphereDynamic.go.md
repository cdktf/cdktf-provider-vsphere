...
```go
import "github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v11/datavspheredynamic"
...
| <code><a href="#@cdktf/provider-vsphere.dataVsphereDynamic.DataVsphereDynamicConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.0/docs/data-sources/dynamic#id DataVsphereDynamic#id}. |
