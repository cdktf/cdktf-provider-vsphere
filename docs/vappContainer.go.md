...
```go
import "github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v5/vappcontainer"
...
| <code><a href="#@cdktf/provider-vsphere.vappContainer.VappContainerConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.4.0/docs/resources/vapp_container#id VappContainer#id}. |
