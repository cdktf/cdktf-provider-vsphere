...
```go
import "github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v10/tagcategory"
...
| <code><a href="#@cdktf/provider-vsphere.tagCategory.TagCategoryConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.12.0/docs/resources/tag_category#id TagCategory#id}. |
