...
```csharp
private void PutHostImage(ComputeClusterHostImage Value)
```
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.12.0/docs/resources/compute_cluster#import import section} in the documentation of this resource for the id to use
...
```csharp
public ComputeClusterHostImageOutputReference HostImage { get; }
```
...
```csharp
public double HaVmRestartAdditionalDelayInput { get; }
```
...
```csharp
public double HostClusterExitTimeoutInput { get; }
```
...
```csharp
public ComputeClusterHostImage HostImageInput { get; }
```
...
```csharp
public string ProactiveHaAutomationLevelInput { get; }
```
...
```csharp
public string ProactiveHaModerateRemediationInput { get; }
```
...
```csharp
public string[] ProactiveHaProviderIdsInput { get; }
```
...
```csharp
public string ProactiveHaSevereRemediationInput { get; }
```
...
```csharp
public double VsanDitRekeyIntervalInput { get; }
```
...
```csharp
public string[] VsanRemoteDatastoreIdsInput { get; }
```
...
```csharp
public ComputeClusterVsanStretchedCluster VsanStretchedClusterInput { get; }
```
...
```csharp
public double DpmThreshold { get; }
```
...
```csharp
public System.Collections.Generic.IDictionary<string, string> DrsAdvancedOptions { get; }
```
...
```csharp
public double DrsMigrationThreshold { get; }
```
...
```csharp
public string DrsScaleDescendantsShares { get; }
```
...
```csharp
public string[] HaAdmissionControlFailoverHostSystemIds { get; }
```
...
```csharp
public double HaAdmissionControlHostFailureTolerance { get; }
```
...
```csharp
public double HaAdmissionControlPerformanceTolerance { get; }
```
...
```csharp
public string HaAdmissionControlPolicy { get; }
```
...
```csharp
public double HaAdmissionControlResourcePercentageCpu { get; }
```
...
```csharp
public double HaAdmissionControlResourcePercentageMemory { get; }
```
...
```csharp
public double HaAdmissionControlSlotPolicyExplicitCpu { get; }
```
...
```csharp
public double HaAdmissionControlSlotPolicyExplicitMemory { get; }
```
...
```csharp
public System.Collections.Generic.IDictionary<string, string> HaAdvancedOptions { get; }
```
...
```csharp
public string[] HaHeartbeatDatastoreIds { get; }
```
...
```csharp
public string HaHeartbeatDatastorePolicy { get; }
```
...
```csharp
public string HaHostMonitoring { get; }
```
...
```csharp
public string HaVmComponentProtection { get; }
```
...
```csharp
public string HaVmDependencyRestartCondition { get; }
```
...
```csharp
public double HaVmRestartAdditionalDelay { get; }
```
...
```csharp
public double HostClusterExitTimeout { get; }
```
...
```csharp
public string ProactiveHaAutomationLevel { get; }
```
...
```csharp
public string ProactiveHaModerateRemediation { get; }
```
...
```csharp
public string[] ProactiveHaProviderIds { get; }
```
...
```csharp
public string ProactiveHaSevereRemediation { get; }
```
...
```csharp
public double VsanDitRekeyInterval { get; }
```
...
```csharp
public string[] VsanRemoteDatastoreIds { get; }
```
...
new ComputeClusterConfig {
    ...
    string HaHostMonitoring = null,
    string HaVmComponentProtection = null,
    string HaVmDependencyRestartCondition = null,
    ...
    double HaVmRestartAdditionalDelay = null,
...
| <code><a href="#@cdktf/provider-vsphere.computeCluster.ComputeClusterConfig.property.haVmFailureInterval">HaVmFailureInterval</a></code> | <code>double</code> | If a heartbeat from a virtual machine is not received within this configured interval, the virtual machine is marked as failed. |
| <code><a href="#@cdktf/provider-vsphere.computeCluster.ComputeClusterConfig.property.haVmMaximumFailureWindow">HaVmMaximumFailureWindow</a></code> | <code>double</code> | The length of the reset window in which ha_vm_maximum_resets can operate. |
| <code><a href="#@cdktf/provider-vsphere.computeCluster.ComputeClusterConfig.property.haVmMaximumResets">HaVmMaximumResets</a></code> | <code>double</code> | The maximum number of resets that HA will perform to a virtual machine when responding to a failure event. |
| <code><a href="#@cdktf/provider-vsphere.computeCluster.ComputeClusterConfig.property.haVmMinimumUptime">HaVmMinimumUptime</a></code> | <code>double</code> | The time, in seconds, that HA waits after powering on a virtual machine before monitoring for heartbeats. |
...
| <code><a href="#@cdktf/provider-vsphere.computeCluster.ComputeClusterConfig.property.haVmRestartAdditionalDelay">HaVmRestartAdditionalDelay</a></code> | <code>double</code> | Additional delay in seconds after ready condition is met. A VM is considered ready at this point. |
...
| <code><a href="#@cdktf/provider-vsphere.computeCluster.ComputeClusterConfig.property.id">Id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.12.0/docs/resources/compute_cluster#id ComputeCluster#id}. |
...
```csharp
public double DpmThreshold { get; set; }
```
...
```csharp
public System.Collections.Generic.IDictionary<string, string> DrsAdvancedOptions { get; set; }
```
...
```csharp
public double DrsMigrationThreshold { get; set; }
```
...
```csharp
public string DrsScaleDescendantsShares { get; set; }
```
...
```csharp
public string[] HaAdmissionControlFailoverHostSystemIds { get; set; }
```
...
```csharp
public double HaAdmissionControlHostFailureTolerance { get; set; }
```
...
```csharp
public double HaAdmissionControlPerformanceTolerance { get; set; }
```
...
```csharp
public string HaAdmissionControlPolicy { get; set; }
```
...
```csharp
public double HaAdmissionControlResourcePercentageCpu { get; set; }
```
...
```csharp
public double HaAdmissionControlResourcePercentageMemory { get; set; }
```
...
```csharp
public double HaAdmissionControlSlotPolicyExplicitCpu { get; set; }
```
...
```csharp
public double HaAdmissionControlSlotPolicyExplicitMemory { get; set; }
```
...
```csharp
public System.Collections.Generic.IDictionary<string, string> HaAdvancedOptions { get; set; }
```
...
```csharp
public string[] HaHeartbeatDatastoreIds { get; set; }
```
...
```csharp
public string HaHeartbeatDatastorePolicy { get; set; }
```
...
```csharp
public string HaHostMonitoring { get; set; }
```
...
```csharp
public string HaVmComponentProtection { get; set; }
```
...
```csharp
public string HaVmDependencyRestartCondition { get; set; }
```
...
```csharp
public double HaVmRestartAdditionalDelay { get; set; }
```
...
```csharp
public double HostClusterExitTimeout { get; set; }
```
...
```csharp
public ComputeClusterHostImage HostImage { get; set; }
```
...
```csharp
public string ProactiveHaAutomationLevel { get; set; }
```
...
```csharp
public string ProactiveHaModerateRemediation { get; set; }
```
...
```csharp
public string[] ProactiveHaProviderIds { get; set; }
```
...
```csharp
public string ProactiveHaSevereRemediation { get; set; }
```
...
```csharp
public double VsanDitRekeyInterval { get; set; }
```
...
```csharp
public string[] VsanRemoteDatastoreIds { get; set; }
```
...
```csharp
public ComputeClusterVsanStretchedCluster VsanStretchedCluster { get; set; }
```
...
new ComputeClusterHostImageComponent {
    string Key = null,
    string Version = null
};
```
...
new ComputeClusterVsanDiskGroup {
    string Cache = null,
    string[] Storage = null
};
```
...
new ComputeClusterVsanFaultDomainsFaultDomain {
    string[] HostIds,
    string Name
};
```
...
new ComputeClusterVsanStretchedCluster {
    string[] PreferredFaultDomainHostIds,
    string[] SecondaryFaultDomainHostIds,
    string WitnessNode,
    string PreferredFaultDomainName = null,
    string SecondaryFaultDomainName = null
};
```
...
```csharp
public string[] PreferredFaultDomainHostIds { get; set; }
```
...
```csharp
public string[] SecondaryFaultDomainHostIds { get; set; }
```
...
```csharp
public string WitnessNode { get; set; }
```
...
```csharp
public string SecondaryFaultDomainName { get; set; }
```
...
new ComputeClusterHostImageComponentList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-vsphere.computeCluster.ComputeClusterHostImageComponentList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktf/provider-vsphere.computeCluster.ComputeClusterHostImageComponentList.resolve.parameter._context"></a>
...
```csharp
private ComputeClusterHostImageComponentOutputReference Get(double Index)
```
...
new ComputeClusterHostImageComponentOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-vsphere.computeCluster.ComputeClusterHostImageComponentOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktf/provider-vsphere.computeCluster.ComputeClusterHostImageComponentOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktf/provider-vsphere.computeCluster.ComputeClusterHostImageComponentOutputReference.resolve.parameter._context"></a>
...
new ComputeClusterHostImageOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-vsphere.computeCluster.ComputeClusterHostImageOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktf/provider-vsphere.computeCluster.ComputeClusterHostImageOutputReference.resolve.parameter._context"></a>
...
```csharp
public ComputeClusterHostImageComponentList Component { get; }
```
...
```csharp
public string EsxVersionInput { get; }
```
...
```csharp
public ComputeClusterHostImage InternalValue { get; }
```
...
new ComputeClusterVsanDiskGroupList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-vsphere.computeCluster.ComputeClusterVsanDiskGroupList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktf/provider-vsphere.computeCluster.ComputeClusterVsanDiskGroupList.resolve.parameter._context"></a>
...
```csharp
private ComputeClusterVsanDiskGroupOutputReference Get(double Index)
```
...
new ComputeClusterVsanDiskGroupOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-vsphere.computeCluster.ComputeClusterVsanDiskGroupOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktf/provider-vsphere.computeCluster.ComputeClusterVsanDiskGroupOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktf/provider-vsphere.computeCluster.ComputeClusterVsanDiskGroupOutputReference.resolve.parameter._context"></a>
...
new ComputeClusterVsanFaultDomainsFaultDomainList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-vsphere.computeCluster.ComputeClusterVsanFaultDomainsFaultDomainList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktf/provider-vsphere.computeCluster.ComputeClusterVsanFaultDomainsFaultDomainList.resolve.parameter._context"></a>
...
```csharp
private ComputeClusterVsanFaultDomainsFaultDomainOutputReference Get(double Index)
```
...
new ComputeClusterVsanFaultDomainsFaultDomainOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-vsphere.computeCluster.ComputeClusterVsanFaultDomainsFaultDomainOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktf/provider-vsphere.computeCluster.ComputeClusterVsanFaultDomainsFaultDomainOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktf/provider-vsphere.computeCluster.ComputeClusterVsanFaultDomainsFaultDomainOutputReference.resolve.parameter._context"></a>
...
new ComputeClusterVsanFaultDomainsList(IInterpolatingParent TerraformResource, string TerraformAttribute, bool WrapsSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-vsphere.computeCluster.ComputeClusterVsanFaultDomainsList.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktf/provider-vsphere.computeCluster.ComputeClusterVsanFaultDomainsList.resolve.parameter._context"></a>
...
```csharp
private ComputeClusterVsanFaultDomainsOutputReference Get(double Index)
```
...
new ComputeClusterVsanFaultDomainsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute, double ComplexObjectIndex, bool ComplexObjectIsFromSet);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-vsphere.computeCluster.ComputeClusterVsanFaultDomainsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktf/provider-vsphere.computeCluster.ComputeClusterVsanFaultDomainsOutputReference.Initializer.parameter.complexObjectIndex">ComplexObjectIndex</a></code> | <code>double</code> | the index of this item in the list. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktf/provider-vsphere.computeCluster.ComputeClusterVsanFaultDomainsOutputReference.resolve.parameter._context"></a>
...
```csharp
public ComputeClusterVsanFaultDomainsFaultDomainList FaultDomain { get; }
```
...
new ComputeClusterVsanStretchedClusterOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-vsphere.computeCluster.ComputeClusterVsanStretchedClusterOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktf/provider-vsphere.computeCluster.ComputeClusterVsanStretchedClusterOutputReference.resolve.parameter._context"></a>
...
```csharp
private void ResetPreferredFaultDomainName()
```
...
```csharp
private void ResetSecondaryFaultDomainName()
```
...
```csharp
public string[] PreferredFaultDomainHostIdsInput { get; }
```
...
```csharp
public string PreferredFaultDomainNameInput { get; }
```
...
```csharp
public string[] SecondaryFaultDomainHostIdsInput { get; }
```
...
```csharp
public string SecondaryFaultDomainNameInput { get; }
```
...
```csharp
public string WitnessNodeInput { get; }
```
...
```csharp
public string[] PreferredFaultDomainHostIds { get; }
```
...
```csharp
public string PreferredFaultDomainName { get; }
```
...
```csharp
public string[] SecondaryFaultDomainHostIds { get; }
```
...
```csharp
public string SecondaryFaultDomainName { get; }
```
...
```csharp
public ComputeClusterVsanStretchedCluster InternalValue { get; }
```
