...
```go
import "github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v10/datastorecluster"
...
| <code><a href="#@cdktf/provider-vsphere.datastoreCluster.DatastoreClusterConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.12.0/docs/resources/datastore_cluster#id DatastoreCluster#id}. |
