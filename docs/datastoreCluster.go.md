...
```go
import "github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v8/datastorecluster"
...
| <code><a href="#@cdktf/provider-vsphere.datastoreCluster.DatastoreClusterConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.5.1/docs/resources/datastore_cluster#id DatastoreCluster#id}. |
