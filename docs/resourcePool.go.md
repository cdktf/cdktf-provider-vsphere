...
```go
import "github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v11/resourcepool"
...
| <code><a href="#@cdktf/provider-vsphere.resourcePool.ResourcePoolConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.2/docs/resources/resource_pool#id ResourcePool#id}. |
