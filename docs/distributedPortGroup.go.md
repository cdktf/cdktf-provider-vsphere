...
```go
import "github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v10/distributedportgroup"
...
| <code><a href="#@cdktf/provider-vsphere.distributedPortGroup.DistributedPortGroupConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.12.0/docs/resources/distributed_port_group#id DistributedPortGroup#id}. |
