...
```go
import "github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v10/provider"
...
| <code><a href="#@cdktf/provider-vsphere.provider.VsphereProviderConfig.property.vcenterServer">VcenterServer</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.13.0/docs#vcenter_server VsphereProvider#vcenter_server}. |
