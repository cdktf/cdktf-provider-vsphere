...
```go
import "github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v4/dpmhostoverride"
...
| <code><a href="#@cdktf/provider-vsphere.dpmHostOverride.DpmHostOverrideConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.4.0/docs/resources/dpm_host_override#id DpmHostOverride#id}. |
