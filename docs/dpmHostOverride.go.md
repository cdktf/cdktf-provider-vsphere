...
```go
import "github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v11/dpmhostoverride"
...
| <code><a href="#@cdktf/provider-vsphere.dpmHostOverride.DpmHostOverrideConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vsphere/2.14.0/docs/resources/dpm_host_override#id DpmHostOverride#id}. |
