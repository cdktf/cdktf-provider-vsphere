...
```go
import "github.com/cdktf/cdktf-provider-vsphere-go/vsphere/v6/datavspherehost"
...
| <code><a href="#@cdktf/provider-vsphere.dataVsphereHost.DataVsphereHostConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vsphere/2.4.0/docs/data-sources/host#id DataVsphereHost#id}. |
